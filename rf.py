...
#         print(NewNodeUsage)
        ...
        if(len(BestLeft)==0 or len(BestRight)==0):
...
start=time.time()
SampleSize=int(0.4*len(ImageListFull))
for i in range(100):
#     print(i)
    modelfile="pred"+'{0:03}'.format(i+1)+".csv"
    ImageList=choices(ImageListFull,k=SampleSize)
    DTree=[]
    NodeIndex=0
